...
var grammar = {
    ...
    {"name": "identifier", "symbols": [(lexer.has("operator") ? {type: "operator"} : operator)], "postprocess": ([{ type, value }]) => ({type, value})},
    ...
    {"name": "property", "symbols": ["property$subexpression$1", (lexer.has("dot") ? {type: "dot"} : dot), "expression"], "postprocess": ([[context],, value]) => ({type: "property", context, value })},
    ...
    {"name": "algebraic$subexpression$1", "symbols": [{"literal":"*"}]},
    {"name": "algebraic$subexpression$1", "symbols": [{"literal":"/"}]},
    {"name": "algebraic$subexpression$2", "symbols": ["identifier"]},
    {"name": "algebraic$subexpression$2", "symbols": ["literal"]},
    {"name": "algebraic$subexpression$2", "symbols": ["property"]},
    {"name": "algebraic$subexpression$2", "symbols": ["functionApplication"]},
    {"name": "algebraic$subexpression$2", "symbols": ["parenthesis"]},
    {"name": "algebraic", "symbols": ["expression", "_", "algebraic$subexpression$1", "_", "algebraic$subexpression$2"], "postprocess": ([left,, [op],, [right]]) => ({operator: op.value, left, right})},
