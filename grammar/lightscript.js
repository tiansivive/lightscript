...
var grammar = {
    ...
    {"name": "script", "symbols": ["script$ebnf$1", "expression", "script$ebnf$2", "script$ebnf$3"], "postprocess":  ([,head, tail]) => {
    ...
    {"name": "gRel", "symbols": [{"literal":"-"}], "postprocess": _ => ({ type: "graph-edge", direction: "bilateral", value: { type: "any" } })},
    {"name": "gRel", "symbols": [{"literal":"-"}, "gRelId", {"literal":"-"}], "postprocess": ([, value,]) => ({ type: "graph-edge", direction: "bilateral", value })},
    {"name": "gRel", "symbols": [{"literal":"-"}, "gRelId", {"literal":"->"}], "postprocess": ([, value,]) => ({ type: "graph-edge", direction: "outgoing", value })},
    {"name": "gRel", "symbols": [{"literal":"<-"}, "gRelId", {"literal":"-"}], "postprocess": ([, value,]) => ({ type: "graph-edge", direction: "incoming", value })},
