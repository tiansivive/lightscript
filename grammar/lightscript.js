...
var grammar = {
    ...
    {"name": "script", "symbols": ["script$ebnf$1", "imports", "expression", "script$ebnf$2", "script$ebnf$3"], "postprocess": B.script},
    ...
    {"name": "import", "symbols": [{"literal":"import"}, "import$subexpression$1", "identifier", "import$subexpression$2", {"literal":"from"}, "import$subexpression$3", "string"], "postprocess": B.importModule},
    ...
    {"name": "operation", "symbols": ["condition"], "postprocess": B.operations.conditional},
    ...
    {"name": "operation", "symbols": ["graphQuery"], "postprocess": B.operations.graphQuery},
    {"name": "operation", "symbols": ["graphMutation"], "postprocess": B.operations.graphMutation},
    ...
    {"name": "graphQuery", "symbols": ["graphQuery$subexpression$1", "_", {"literal":"|-"}, "_", "graphQuery$subexpression$2"], "postprocess": B.graphQuery},
    ...
    {"name": "graphMutation", "symbols": ["graphMutation$subexpression$1", "_", {"literal":"-|"}, "_", "graphMutation$subexpression$2"], "postprocess": B.graphMutation},
    ...
    {"name": "functionApplication", "symbols": ["identifier", "_", "functionApplication$ebnf$1", "parameters"], "postprocess": B.backApply},
    ...
    {"name": "graph", "symbols": [(lexer.has("lchevron") ? {type: "lchevron"} : lchevron), "graph$ebnf$1", (lexer.has("rchevron") ? {type: "rchevron"} : rchevron)], "postprocess": B.emptyGraph},
    ...
    {"name": "graph", "symbols": [(lexer.has("lchevron") ? {type: "lchevron"} : lchevron), "graph$ebnf$2", "graph$subexpression$1", "graph$ebnf$3", "graph$ebnf$4", (lexer.has("rchevron") ? {type: "rchevron"} : rchevron)], "postprocess": B.graph},
