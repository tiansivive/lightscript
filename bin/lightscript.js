...
var grammar = {
    ...
    {"name": "tuple$ebnf$1", "symbols": ["tuple$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple$ebnf$2", "symbols": []},
    {"name": "tuple$ebnf$2", "symbols": ["tuple$ebnf$2", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple$ebnf$3$subexpression$1$ebnf$1", "symbols": []},
    {"name": "tuple$ebnf$3$subexpression$1$ebnf$1", "symbols": ["tuple$ebnf$3$subexpression$1$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple$ebnf$3$subexpression$1", "symbols": [{"literal":","}, "tuple$ebnf$3$subexpression$1$ebnf$1", "expression"]},
    {"name": "tuple$ebnf$3", "symbols": ["tuple$ebnf$3$subexpression$1"]},
    {"name": "tuple$ebnf$3$subexpression$2$ebnf$1", "symbols": []},
    {"name": "tuple$ebnf$3$subexpression$2$ebnf$1", "symbols": ["tuple$ebnf$3$subexpression$2$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple$ebnf$3$subexpression$2", "symbols": [{"literal":","}, "tuple$ebnf$3$subexpression$2$ebnf$1", "expression"]},
    {"name": "tuple$ebnf$3", "symbols": ["tuple$ebnf$3", "tuple$ebnf$3$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple$ebnf$4", "symbols": []},
    {"name": "tuple$ebnf$4", "symbols": ["tuple$ebnf$4", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "tuple", "symbols": [{"literal":"("}, "tuple$ebnf$1", "expression", "tuple$ebnf$2", "tuple$ebnf$3", "tuple$ebnf$4", {"literal":")"}], "postprocess": B.tuple},
    {"name": "list$ebnf$1", "symbols": []},
    {"name": "list$ebnf$1", "symbols": ["list$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list", "symbols": [{"literal":"["}, "list$ebnf$1", {"literal":"]"}], "postprocess": () => []},
    {"name": "list$ebnf$2", "symbols": []},
    {"name": "list$ebnf$2", "symbols": ["list$ebnf$2", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list$ebnf$3", "symbols": []},
    {"name": "list$ebnf$3", "symbols": ["list$ebnf$3", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list$ebnf$4", "symbols": []},
    {"name": "list$ebnf$4$subexpression$1$ebnf$1", "symbols": []},
    {"name": "list$ebnf$4$subexpression$1$ebnf$1", "symbols": ["list$ebnf$4$subexpression$1$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list$ebnf$4$subexpression$1", "symbols": [{"literal":","}, "list$ebnf$4$subexpression$1$ebnf$1", "expression"]},
    {"name": "list$ebnf$4", "symbols": ["list$ebnf$4", "list$ebnf$4$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list$ebnf$5", "symbols": []},
    {"name": "list$ebnf$5", "symbols": ["list$ebnf$5", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list", "symbols": [{"literal":"["}, "list$ebnf$2", "expression", "list$ebnf$3", "list$ebnf$4", "list$ebnf$5", {"literal":"]"}], "postprocess": B.list},
    ...
    {"name": "parenthesis$ebnf$1", "symbols": []},
    {"name": "parenthesis$ebnf$1", "symbols": ["parenthesis$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "parenthesis$ebnf$2", "symbols": []},
    {"name": "parenthesis$ebnf$2", "symbols": ["parenthesis$ebnf$2", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "parenthesis", "symbols": [{"literal":"("}, "parenthesis$ebnf$1", "expression", "parenthesis$ebnf$2", {"literal":")"}], "postprocess": B.parenthesis},
    ...
    {"name": "parameter", "symbols": ["property"], "postprocess": id},
    {"name": "parameter", "symbols": ["operation"], "postprocess": id},
    {"name": "parameter", "symbols": ["function"], "postprocess": id},
    ...
    {"name": "modules$ebnf$1$subexpression$1$ebnf$1", "symbols": ["modules$ebnf$1$subexpression$1$ebnf$1", "__"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
